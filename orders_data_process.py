...
def main(date):
    ...
    # gs://airflow-project-dev2/data/orders_20250918.csv
    
    input_path = f"gs://airflow-project-dev2/data/orders_{date}.csv"
    ...
    # gs://airflow-project-dev2/output/
    output_path = f"gs://airflow-project-dev2/output/processed_orders_{date}"
